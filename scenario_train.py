...
def main():
    ...
    print(
        ...
        f'timesteps={args.timesteps} bc_init={bc_init_path is not None}'
    )
    model.learn(total_timesteps=args.timesteps, callback=checkpoint_callback, progress_bar=progress_bar)
