...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/doom2/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
Vibe Check：有稳定 baseline，能持续探索并偶尔做出合理战斗动作。
...
默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/doom2/model_path.txt)。
