...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/freedoom2/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
Vibe Check：比 freedoom1 更复杂时仍保留基本的行动连续性。
...
默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/freedoom2/model_path.txt)。
