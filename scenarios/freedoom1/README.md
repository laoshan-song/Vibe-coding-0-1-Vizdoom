...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/freedoom1/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
Vibe Check：能在完整流程里维持较长时间行动，不轻易卡死。
...
默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/freedoom1/model_path.txt)。
