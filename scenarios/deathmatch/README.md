...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/deathmatch/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/deathmatch/model_path.txt)。
