...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/defend_the_line/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
Vibe Check：会比 defend_the_center 更稳，较少无意义乱晃。
...
推荐下一站：[`health_gathering`](/home/laoshansong/vizdoom_project/scenarios/health_gathering/README.md)

## 模型文件说明

默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/defend_the_line/model_path.txt)。
