...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/learning/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
Vibe Check：表现接近 basic，已经形成稳定的左右修正与开火习惯。
...
默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/learning/model_path.txt)。
