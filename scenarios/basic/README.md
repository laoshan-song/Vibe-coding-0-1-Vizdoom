...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/basic/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
教师或奖励里经常会围绕这些目标对象做设计：`Cacodemon、DoomPlayer`。
...
推荐下一站：[`defend_the_center`](/home/laoshansong/vizdoom_project/scenarios/defend_the_center/README.md)

## 模型文件说明

默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/basic/model_path.txt)。
