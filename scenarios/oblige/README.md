...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/oblige/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
Vibe Check：面对随机地图也能维持最低限度的探索和战斗策略。
...
默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/oblige/model_path.txt)。
