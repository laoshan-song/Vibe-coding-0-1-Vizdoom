...
运行 train.py
   |
   v
保存模型到 artifacts/scenarios/basic_audio/ppo_model.zip
   |
   v
运行 play.py 观察行为
```
...
Vibe Check：在基础射击逻辑稳定后，能继续保持对准和开火节奏。
...
默认模型路径见 [`model_path.txt`](/home/laoshansong/vizdoom_project/scenarios/basic_audio/model_path.txt)。
